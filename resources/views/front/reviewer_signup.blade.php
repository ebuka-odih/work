    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <aside>
                        ...
                        <h4 class="text text-center">Reviewer Form</h4>
                        <hr>
                        <div>
        ...
        <div class="col-sm-3">
            <div class="card position-fixed">
                <div class="card-body">
                    <h5 class="card-title">Reviewer Notice</h5>
                    <p class="card-text">In no way your identity should be made known to the world or to the uploader</p>
                    <p class="card-text">your information is safe and secure, bank details are optional but neccessary if the commission want to compasate you
                    for time taken to review a project. Thanks</p>
                </div>
            </div>
        </div>
    </div>
